...
gen_omero_tables.celltype_cluster_tables(sample_names_path = sample_names_path, cluster_path = clustering_path, 
                                    omero_table_path = omero_table_dir, omero_dict = config.omero_image_dict, 
                                    table_name = table_name_celltype_clusters, n_clusters = config.n_clusters_celltypes)
