...
get_normalized_matrix(save_path = config.out_dir, raw_data_dir = config.segementation_data_dir, thresholded_dir = thresholded_dir, channel_names = config.channel_names, filtered_channel_names = config.filtered_channel_names, samples_to_remove = None) 
#call umap function 
...
metadata_per_sample.split_metadata_by_sample(metadata_path = metadata_with_clusters_path, save_path = metadata_per_sample_path, data_dir = config.data_dir, n_clusters = config.n_clusters, samples_to_remove= None)
#analyze results 
