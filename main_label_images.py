...
#paths
tile_dir = os.path.join(config.out_dir, config.cell_marker_matrix_dir)
label_images_dir = os.path.join(config.out_dir, config.label_images_dir)
metadata_path = os.path.join(config.out_dir, config.clustering_dir, 'metadata_with_cluster_labels.csv')


split_data_by_sample.split_by_sample(tile_dir = tile_dir, metadata_path= metadata_path, label_images_dir = label_images_dir, data_dir = config.data_dir, samples_to_remove = config.samples_to_skip)
