...
threshold_markers(data_dir = config.segementation_data_dir, channel_names = config.channel_names, 
                threshold_dict = config.thresholding_biomarkers_dict, 
...
get_normalized_matrix(save_path = config.out_dir, raw_data_dir = config.segementation_data_dir, 
